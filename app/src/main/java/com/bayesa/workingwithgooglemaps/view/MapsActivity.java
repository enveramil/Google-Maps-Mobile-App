...
import com.bayesa.workingwithgooglemaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLauncher();
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.bayesa.workingwithgooglemaps",MODE_PRIVATE);
        info = false;
...
/*
                // Bir kere güncellemesi için çalışacak.
                // Çalıştırılıp çalıştırılmadığını bir kere kontrol edicek.
                // SharedPreferences içerisinde kayıtlı bir info var yoksa default değeri false dur.
                // ilk defa çalıştırıldığında böyle kayıtlı bir şey olmayacağından false olacaktır.
 ...
 */
        ...
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            //request permission
            //Android işletim sisteminin sorduğu mantığı kullancağız
            if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.ACCESS_FINE_LOCATION)){
                Snackbar.make(binding.getRoot(),"permission needed",Snackbar.LENGTH_INDEFINITE).setAction("Give Permission", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // request permission
                        // permission ları gerçekleştirebilmek için ActivityResultLauncher lara ihtiyacımız var
            ...
            // izin verildiği anlaşılır ve direk konumu almaya başlar.
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,10000,10,locationListener);

            // Kullanıcının son bilinen konumunu alma işlemi
    ...
    public void save(View view){
        String placeName = binding.editText.getText().toString();
